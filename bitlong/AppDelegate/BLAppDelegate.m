...
-(void)getLndState{
    ...
    [NSTimer scheduledTimerWithTimeInterval:1.0 repeats:YES block:^(NSTimer * _Nonnull timer) {
        ...
        if ([litStatus isEqualToString:@"WAITING_TO_START"]){
        }else if ([litStatus isEqualToString:@"NON_EXISTING"]){
            [weakSelf initWalletVC];
            [timer invalidate];
        }else if ([litStatus isEqualToString:@"LOCKED"]){ 
        ...
        }else if ([litStatus isEqualToString:@"UNLOCKED"]){
            static dispatch_once_t onceToken;
            dispatch_once(&onceToken, ^{
        ...
        }else if ([litStatus isEqualToString:@"RPC_ACTIVE"]){
        }else if ([litStatus isEqualToString:@"SERVER_ACTIVE"]){
            [weakSelf getTapState];
            [timer invalidate];
        }else if ([litStatus isEqualToString:@"NO_START_LND"]){
...
//        [litText appendString:@"\n"];
////            [litText appendString:@"lnd.bitcoind.rpchost=202.79.173.41"]; 
//        [litText appendString:@"lnd.bitcoind.rpchost=192.168.110.42"];    
//        [litText appendString:@"\n"];
////            [litText appendString:@"lnd.bitcoind.rpcuser=tapuser"];       
//        [litText appendString:@"lnd.bitcoind.rpcuser=rpcuser"];             
//        [litText appendString:@"\n"];
////            [litText appendString:@"lnd.bitcoind.rpcpass=lndtappwd"];     
//        [litText appendString:@"lnd.bitcoind.rpcpass=rpcpassword"];         
//        [litText appendString:@"\n"];
////            [litText appendString:@"lnd.bitcoind.zmqpubrawblock=tcp://202.79.173.41:28332"]; 
//        [litText appendString:@"lnd.bitcoind.zmqpubrawblock=tcp://192.168.110.42:28332"];    
//        [litText appendString:@"\n"];
////            [litText appendString:@"lnd.bitcoind.zmqpubrawtx=tcp://202.79.173.41:28333"];    
//        [litText appendString:@"lnd.bitcoind.zmqpubrawtx=tcp://192.168.110.42:28333"];       
//        [litText appendString:@"\n"];
...
//        [litText appendString:@"lnd.bitcoin.active=true"];
//        [litText appendString:@"\n"];
//        [litText appendString:@"lnd.bitcoin.node=neutrino"]; 
//        [litText appendString:@"\n"];
...
//        ApiSetPath(documentsDirectory,@"testnet"); 
        ApiSetPath(documentsDirectory,@"regtest"); 
//        ApiSetPath(documentsDirectory,@"mainnet"); 
        NSLog(@"ApiGetPath:\n%@",ApiGetPath());
